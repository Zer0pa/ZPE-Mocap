...
1. Python package runtime and CLI (`code/zpe_mocap`).
2. Proof-generation, benchmark, and ingestion scripts (`code/scripts`).
3. CI and release pipeline configurations.

## Reporting

Please report vulnerabilities privately to the project owner at `architects@zer0pa.ai` with:
