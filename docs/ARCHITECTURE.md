...
<table width="100%" border="1" bordercolor="#111111" cellpadding="14" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">Current promoted authority bundle for the committed CMU fixture benchmark surfaced in the README.</td>
    </tr>
    <tr>
...
<table width="100%" border="1" bordercolor="#111111" cellpadding="14" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">The promoted authority bundle is the committed 10-clip CMU fixture benchmark; the synthetic wave1 bundle remains historical lineage only.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top">Full ACL and external corpus clones remain outside the tracked repo boundary; the committed CMU fixture subset under <code>code/fixtures/cmu/</code> is the reproducible in-repo corpus surface.</td>
    </tr>
  </tbody>
</table>
